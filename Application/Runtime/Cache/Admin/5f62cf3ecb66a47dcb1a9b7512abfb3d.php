...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="/index.php/Admin/Goods/goodsList" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Goods/goodsAdd" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Cate/categoryList" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Brand/brandList" target="main-frame">商品品牌</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Goods/goodsTrash" target="main-frame">商品回收站</a></li>
                </ul>
            </li>
